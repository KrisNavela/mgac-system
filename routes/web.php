...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/forbondapprovalrequisitions/{id}/approved-bondapproval', [ForBondApprovalRequisitionController::class, 'approvedbondapproval'])->name('forbondapprovalrequisitions.approved.bondapproval');
});
