...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/cocapprovalrequisitions/{id}/approved-cocapproval', [COCApprovalController::class, 'approvedcocapproval'])->name('approvedrequisitions.approved.cocapproval');
});
