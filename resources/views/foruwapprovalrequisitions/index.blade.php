            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('foruwapprovalrequisitions.approved.uwapproval', $requisition->id)}}" class="bg-green-500 text-white hover:bg-green-700 text-sm px-2 py-1 rounded-md">Approved</a>
                    </div>
                </div>
                @endforeach
            </div>
