    ...
    <div class="flex justify-end">    
                        ...
                        <div class="py-4 text-sm text-gray-800 font-semibold">
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                <div class="bg-white shadow-sm sm:rounded-lg p-4">
                                    ...
                                    <form method="POST" action="{{ route('forbondapprovalrequisitions.update.bondapproval', $requisition->id) }}" onsubmit="return disableBondButton(this);">
                                        @csrf
                                        @method('PUT')
                                        <div class="mt-4">
                                        ...
                                        <div class="mt-4">
                                            <button id="bondSubmitBtn" type="submit" 
                                    ...
                                    <script>
                                        function disableBondButton(form) {
                                            const btn = form.querySelector('#bondSubmitBtn');
                                            btn.disabled = true;
        ...
        <script>
            function toggleModal(modalID) {
                ...
                <form action="{{ route('forbondapprovalrequisitions.update', $requisition->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mt-4">
