    ...
    <div class="container">
        ...
        <div class="details">
            <ul>
                ...
                <li><strong>Courier:</strong> {{ $requisition->delivery_name }}</li>
                <li><strong>Courier No.:</strong> {{ $requisition->delivery_no }}</li>
                <li><strong>Delivery Date:</strong> {{ $requisition->delivery_date }}</li>
            </ul>
        </div>
