                    ...
                    <table class="min-w-full divide-y divide-gray-200 mt-2">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="px-6 py-4 whitespace-nowrap">
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->id }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->branch_code }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->branch_name }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->manager_name }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->manager_position }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->address1 }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->address2 }}</td>
                                <td class="px-6 py-3 text=left text-xs font-medium text-gray-800 uppercase">{{ $branch->type_office }}</td>
                                <td>
